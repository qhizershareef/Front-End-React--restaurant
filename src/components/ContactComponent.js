...
class Contact extends Component {
    constructor(props){
        ...
        //bind the methods to this.state as to handle events, bind() is used to handle events for this
        //bind() method is used to tie the state dependance to handlers, in simple words whenever we use event handling or listeners, if there is dependancy on state we use bind() 
    ...
    handleInputChange(e){
        ...
        //it was e.target.value so inorder to update we need to setState()
        this.setState({
            [name]:value,//it reflects to any of the changes applied to any of the column
        })
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="row">
                    <Breadcrumb>
                        <BreadcrumbItem><Link to='/qhome'>Home</Link></BreadcrumbItem>
